...
log = pd.read_csv("D:\\dataquest\\projects\\game_log.csv",engine='python')
print(log.shape)
log.head()

log.tail()

person = pd.read_csv('D:\\dataquest\\projects\\person_codes.csv')
print(person.shape)
person.head()

park = pd.read_csv('D:\\dataquest\\projects\\park_codes.csv')
print(park.shape)
park.head()

team = pd.read_csv('D:\\dataquest\\projects\\team_codes.csv')
print(team.shape)
team.head()
